...
const QUEST = [
  {
    ...
    pool: [
      ...
      {
        question: "יש לכם 100 שקלים. מה מהרשימה הוא צורך?",
        answers: [
          "אוכל לארוחת ערב",
          "משחק חדש לטלפון",
          "מדבקות לקלמר",
  ...
  },
  {
    ...
    pool: [
      ...
      {
        question: "קרטון חלב של 1 ליטר עולה 7 שקלים, ושל 2 ליטר עולה 12. מה זול יותר לליטר?",
        answers: [
          "הגדול. 12 חלקי 2 זה 6 שקלים לליטר, מול 7",
          "הקטן, כי הוא עולה פחות בסך הכול",
          "בדיוק אותו דבר",
      ...
      {
        question: "שלט בשוק צועק: המבצע נגמר בעוד 10 דקות! למה כתבו את זה ככה?",
        answers: [
  ...
  },
  {
    ...
    pool: [
      ...
      {
        question: "קיבלתם 200 שקלים במתנה. לפי הכלל, כמה מהם נכנסים לחיסכון?",
        answers: [
          "40 שקלים",
          "20 שקלים",
          "100 שקלים",
    ...
    lesson: "כלל 50־30־20: חצי מההכנסה לצרכים, 30 אחוז לרצונות, ו-20 אחוז לחיסכון. לכל שקל יש תפקיד מראש.",
    draw(ctx, t, curse) {
  ...
  },
  {
    ...
    pool: [
      ...
      {
        question: "הפקדתם 100 שקלים בריבית של 10 אחוז בשנה. כמה יהיה אחרי שנתיים?",
        answers: [
          "121 שקלים",
          "120 שקלים",
          "110 שקלים",
  ...
  },
  {
    ...
    pool: [
      ...
      {
        question: "למה מטבע של 10 שקלים שווה יותר ממטבע של שקל, אם המתכת דומה?",
        answers: [
