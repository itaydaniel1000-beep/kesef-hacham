...
const BOSS_QUESTIONS = [
  ...
  {q: "כמה לחיסכון בכלל 50־30־20?", a: ["עשרים אחוז", "שלושים אחוז", "חמישים אחוז", "חמישה אחוז"], c: 0},
  {q: "כמה לצרכים בכלל 50־30־20?", a: ["חמישים אחוז", "שלושים אחוז", "עשרים אחוז", "שבעים אחוז"], c: 0},
  {q: "קרן חירום מכסה כמה חודשים?", a: ["שלושה עד שישה", "יום אחד", "עשר שנים", "חצי שעה"], c: 0},
  ...
  {q: "מאה שקלים בעשרה אחוז לשנתיים הם…", a: ["מאה עשרים ואחד", "מאה עשרים", "מאה עשר", "מאתיים"], c: 0},
