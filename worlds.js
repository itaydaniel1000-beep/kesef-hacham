...
const COMPARE_ROUNDS = [
  {
    options: [
      {art: "milk", name: "קרטון חלב", size: "ליטר אחד", price: "שישה שקלים", unit: "שישה לליטר"},
      {art: "milk", name: "קרטון חלב", size: "שני ליטר", price: "שלושה עשר שקלים", unit: "שישה וחצי לליטר"}
    ],
    better: 0,
    why: "הגדול נראה משתלם, אבל המחיר לליטר שלו גבוה יותר."
  },
  {
    options: [
      {art: "rice", name: "שק אורז", size: "קילו אחד", price: "תשעה שקלים", unit: "תשעה לקילו"},
      {art: "rice", name: "שק אורז", size: "שלושה קילו", price: "עשרים וארבעה שקלים", unit: "שמונה לקילו"}
    ],
    better: 1,
    why: "כאן דווקא הגדול זול יותר לקילו. תמיד בודקים, לא מנחשים."
  },
  {
    options: [
      {art: "juice", name: "בקבוק מיץ", size: "חצי ליטר", price: "ארבעה שקלים", unit: "שמונה לליטר"},
      {art: "juice", name: "בקבוק מיץ", size: "ליטר וחצי", price: "עשרה וחצי שקלים", unit: "שבעה לליטר"}
    ],
    better: 1,
    why: "שבעה לליטר מול שמונה. הגדול משתלם."
  },
  {
    options: [
      {art: "milk", name: "קרטון חלב", size: "ליטר אחד", price: "שבעה שקלים", unit: "שבעה לליטר"},
      {art: "milk", name: "קרטון חלב", size: "שני ליטר", price: "שנים עשר שקלים", unit: "שישה לליטר"}
    ],
    better: 1,
    why: "שישה לליטר מול שבעה. הפעם הגדול עדיף."
  },
  {
    options: [
      {art: "rice", name: "שק אורז", size: "שני קילו", price: "ארבעה עשר שקלים", unit: "שבעה לקילו"},
      {art: "rice", name: "שק אורז", size: "חמישה קילו", price: "ארבעים שקלים", unit: "שמונה לקילו"}
    ],
    better: 0,
    why: "אריזה גדולה לא תמיד זולה יותר ליחידה."
  },
  {
    options: [
      {art: "juice", name: "בקבוק מיץ", size: "ליטר אחד", price: "תשעה שקלים", unit: "תשעה לליטר"},
      {art: "juice", name: "בקבוק מיץ", size: "שלושה ליטר", price: "עשרים ואחד שקלים", unit: "שבעה לליטר"}
    ],
    better: 1,
    why: "שבעה לליטר. חיסכון אמיתי, כי זה מוצר שממילא קונים."
  }
];

const BUDGET_ROUNDS = [
  {coins: 10, label: "עשרה מטבעות מהמכירה של היום", why: "חמישה לצרכים, שלושה לרצונות, שניים לחיסכון."},
  {coins: 20, label: "עשרים מטבעות מהמטען שהגיע", why: "עשרה, שישה וארבעה. אותו יחס בדיוק, רק בגדול."},
  {coins: 10, label: "עשרה מטבעות מהשכר של השבוע", why: "היחס נשאר קבוע בלי קשר לסכום. זה הכוח של הכלל."}
];

const SCAM_OFFERS = [
  {text: "השקיעו מאה מטבעות, וקבלו אלף תוך שבוע. מובטח!", scam: true,
   why: "רווח של פי עשרה בשבוע, ועוד מובטח. אין דבר כזה."},
  {text: "פיקדון בבנק הממלכה, שלושה אחוזים ריבית בשנה.", scam: false,
  ...
  {text: "החליטו בחמש הדקות הקרובות, אחר כך ההצעה נעלמת לנצח.", scam: true,
